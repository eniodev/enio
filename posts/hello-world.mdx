...
1. Start Line
    1. Contains the protocol version, followed by the response code and a short descriptive message.
...
1. Headers
    1. Contains information related to the response, such as resource type and size.
...
1. Body
    1. As with the request, this is where the requested resource is located.
